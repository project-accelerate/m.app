...
export async function graphqlSchema() {
  ...
  execSync("node_modules/.bin/apollo-codegen generate frontend/web/**/*.graphql --schema schema.json --target typescript --output frontend/native/queries.ts")
  execSync("node_modules/.bin/apollo-codegen generate frontend/web/**/*.graphql --schema schema.json --target typescript --output frontend/web/queries.ts")
}
